...
$data = ['url' => 'https://static.api4.ai/samples/image-upscale-1.png'];
...
$img_format = strtolower($raw_response['results'][0]['entities'][0]['format']);

// Write image data to the file.
file_put_contents("result.{$img_format}", base64_decode($img_base_64_str));

echo "\n", "💬 The 'result.{$img_format}' image is saved to the current directory.", "\n";
?>
